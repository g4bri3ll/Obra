...
<title>Relatorio total de custo adicionais por contrato</title>
<!-- BOOTSTRAP STYLES-->
    ...
    <div style="color: white; padding: 15px 50px 5px 50px; float: right; font-size: 16px;"> 
		...
		<div id="page-wrapper">
			<div id="page-inner">
				<div class="row">
					<div class="col-md-12">
						<h2>Relatorio de custo adicionais</h2>
					</div>
				</div>
				<!-- /. ROW  -->
				<hr />
							...
							<div class="panel-body">
								<div class="row">
									<div class="col-md-8">
										...
										<form role="form" action="GeraRelatorioTotalCustoAdicionais.php" method="post">
