...
<title>Lista todos funcionarios</title>
<!-- BOOTSTRAP STYLES-->
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                ...
                                <ul class="nav nav-third-level">
                                    ...
                                    <li>
                                        <a class="active-menu" href="lista_funcionarios.php">Lista de funcionarios</a>
                                    </li>
                                    <li>
		...
		<div id="page-wrapper">
			<div id="page-inner">
				<div class="row">
					<div class="col-md-12">
						<h2>Funcionarios</h2>
						<h5>Welcome a pagina de funcionarios.</h5>
...
if (!empty($_GET['acao']) || !empty($_GET['exc'])){
	...
	if ($recebe === "excluir"){
		...
		$verificaResult = $funDAO->CancelarPeloId($status, $id);
		if ($verificaResult){
			?> <script type="text/javascript"> alert('Funcionario excluido com sucesso'); window.location="lista_funcionarios.php"</script> <?php
        } else {
        	?> <script type="text/javascript"> alert('Erro ao excluir o funcionario!'); window.location="index.php"</script> <?php
        }
	}
}
?>
							...
							<div class="panel-body">
								<div class="table-responsive">
									<table class="table table-striped table-bordered table-hover"
										...
										foreach ($arrayFuncionario as $funDAO => $valor){
											?>
										<tbody>
											<tr class="odd gradeX">
												...
												<td class="center" align="center">
													<a href="lista_funcionarios.php?acao=excluir&exc=<?php echo $valor['id']; ?>" class="fa fa-trash-o fa-3x"></a> 
												</td>
											</tr>
