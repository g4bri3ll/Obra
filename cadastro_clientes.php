<?php
include_once 'src/modal/table/Clientes.php';
...
<body>
    ...
    <div style="color: white; padding: 15px 50px 5px 50px; float: right; font-size: 16px;"> 
				...
				<li class="text-center">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="active-menu"  href="cadastro_clientes.php">Cadastro de clientes</a>
                            </li>
                            <li>
			...
			<div id="page-inner">
				<div class="row">
					<div class="col-md-12">
						...
						<h5>Welcome ao cadastro de clientes.</h5>
		...
		<?php
		if (!empty($_POST)){
			if (empty($_POST['nome']) || empty($_POST['telefone']) || empty($_POST['endereco']) || empty($_POST['cpf']) || empty($_POST['rg']) || empty($_POST['email'])){
		?>
		...
		<?php
				...
				$validar = $cliDAO->ValidarDados($nome, $telefone, $rg, $cpf, $email);
				...
				if (empty($validar)){
					...
					$cliDAO = new ControllerCliente();
					$result = $cliDAO->cadastrar($clientes);
		...
		?>
							...
							<div class="panel-body">
								<div class="row">
									<div class="col-md-12">
										<h3>Informe um novo cliente</h3>
										<form role="form" action="" method="post">
											<div class="form-group">
												<label>Nome:</label> <input name="nome" class="form-control" />
											</div>
											<div class="form-group">
												<label>CPF:</label> <input name="cpf" class="form-control" />
											</div>
											<div class="form-group">
												<label>RG:</label> <input name="rg" class="form-control" />
											</div>
											<div class="form-group">
